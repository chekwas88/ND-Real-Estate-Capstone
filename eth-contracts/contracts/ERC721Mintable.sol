...
contract Pausable is Ownable {
    ...
    function pause() public onlyOwner view returns(bool){
         return _paused;
     }
     function pauseExec() public onlyOwner whenNotPaused {
         _paused = true;
         emit Paused(msg.sender);
     }

     function unPauseExec() public onlyOwner paused {
         _paused = false;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "address to appove must not be owners address");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner() || isApprovedForAll(owner(), msg.sender), "caller is not owner or approved to make this call");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) || to != address(0), "Ivalid to: address or token already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "caller is not owner of token");
        // TODO: require token is being transfered to valid address
        require(to != address(0), "address to transfer to must be valid");
        // TODO: clear approval
...
contract CustomERC721Token is ERC721Metadata {
    ...
    constructor() public ERC721Metadata("Monsters Property Token", "MPT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
